...
class NewArrived extends StatefulWidget {
  const NewArrived({super.key});

  @override
  State<NewArrived> createState() => _NewArrivedState();
}

class _NewArrivedState extends State<NewArrived> {
  ...
  void initState() {
    ...
    super.initState();
    filteredProducts = _noteGetxController.lastProducts;
  ...
  void filterProducts() {
    ...
    if (query.isNotEmpty) {
      tempList = _noteGetxController.lastProducts.where((product) {
        return product.name!.toLowerCase().contains(query.toLowerCase());
      }).toList();
    } else {
      tempList = _noteGetxController.lastProducts;
    }
