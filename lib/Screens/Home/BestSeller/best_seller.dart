...
class _BestSellerState extends State<BestSeller> {
  ...
  void initState() {
    ...
    super.initState();
    filteredProducts = _noteGetxController.bestSellerProducts;
  ...
  void filterProducts() {
    ...
    if (query.isNotEmpty) {
      tempList = _noteGetxController.bestSellerProducts.where((product) {
        return product.name!.toLowerCase().contains(query.toLowerCase());
      }).toList();
    } else {
      tempList = _noteGetxController.bestSellerProducts;
    }
