...
class ApiRegionController {
  Future<List<Zones>> getRegion() async {
    ...
    final request = await httpClient.getUrl(
      Uri.parse(
          'https://appma.markatstore.com/index.php?route=extension/gwsocapi/module/api/gws_zone&api_key=2P9m8R4AT570rE'),
    );
    request.headers
    ...
    if (response.statusCode == 200) {
      ...
      var jsonResopnse = json.decode(jsonResponse)['zones'] as List;
      print(jsonResopnse);

      return jsonResopnse
          .map((jsonObject) => Zones.fromJson(jsonObject))
          .toList();
    } else {
      // Handle errors
      print(response.statusCode);
