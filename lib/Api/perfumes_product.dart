...
class PerfumesProductController {
  Future<List<Products>> gePerfumesProduct() async {
    ...
    final request = await httpClient.getUrl(
      Uri.parse(
          'https://appma.markatstore.com/index.php?route=extension/gwsocapi/module/api/gws_products&category_id=64&api_key=2P9m8R4AT570rE'),
    );
    request.headers
