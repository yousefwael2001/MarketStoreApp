...
class BestSellerProductController {
  Future<List<Products>> getBestSellerProduct() async {
    ...
    final request = await httpClient.getUrl(
      Uri.parse(
          'https://appma.markatstore.com/index.php?route=extension/gwsocapi/module/api/gws_products_popular&api_key=2P9m8R4AT570rE'),
    );
    request.headers
    ...
    if (response.statusCode == 200) {
      ...
      var jsonResopnse = json.decode(jsonResponse)['popular_products'] as List;
      print(jsonResopnse);
