...
class PrandsController {
  Future<List<Prands>> getPrands() async {
    ...
    final request = await httpClient.getUrl(
      Uri.parse(
          'https://appma.markatstore.com/index.php?route=extension/gwsocapi/module/api/gws_manufacturers&api_key=2P9m8R4AT570rE'),
    );
    request.headers
    ...
    if (response.statusCode == 200) {
      ...
      var jsonResopnse = json.decode(jsonResponse)['manufacturers'] as List;
      print(jsonResopnse);

      return jsonResopnse
          .map((jsonObject) => Prands.fromJson(jsonObject))
          .toList();
    } else {
      // Handle errors
      print(response.statusCode);
